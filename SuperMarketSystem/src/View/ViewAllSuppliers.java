...
public class ViewAllSuppliers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        SupViewTable = new javax.swing.JTable();
        ...
        SupViewTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Supplier", "Supplier ID", "Product Category", "Contact"
            }
        ));
        jScrollPane1.setViewportView(SupViewTable);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(78, 130, 580, 270));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 48)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Detais of Suppliers");
        ...
        jPanel1.add(BackBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 420, -1, -1));
        ...
        jPanel1.add(DeleteBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 420, -1, -1));
    ...
    private void DeleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteBtnActionPerformed
        // TODO add your handling code here:                
        int R = SupViewTable.getSelectedRow();
        
        if(R>=0){
            String SID = SupViewTable.getValueAt(R, 1).toString();
            DeleteController.DeleteSupplierFromTable(SID);
            
            super.dispose();
            AdminMenu refresh = new AdminMenu();
            refresh.ViewAllSuppliers();
        }
        else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAllSuppliers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAllSuppliers().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTable SupViewTable;
